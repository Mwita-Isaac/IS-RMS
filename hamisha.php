...
if(isset($_POST['hamisha'])){

 $info = $_POST['id'];
 $chagua = $_POST['namee'];
 

$sql = "UPDATE info SET kaya_id ='$chagua'  WHERE id='$info'";
               ...
               ?>
                ...
                <form class="text-center" data-bss-hover-animate="" style="text-align: left;" method="post">
                    ...
                    <div style="margin: 3px;">
                          <label class="form-label" for="" style="color: rgb(0,0,0);margin: 3px;">NAMBARI YA MKAZI*:</label>
                          <div class="col-sm-6">
                          <select class="form-control form-control-lg border-dark shadow-lg form-select form-select-lg" style="width: 500px;margin: 3px; color: #fc0339;" name="namee" required>
                                  <optgroup label="Changua nambari mpya ya mkazi" required>
                                            <?php
                                                $sql = mysqli_query($db, "SELECT * FROM data");
                                                while($s = mysqli_fetch_array($sql)){
                                             ?>
                                      <option value="<?php echo $s['data_id'] ?>"><?php echo $s['nyumba_no'] ?></option> 
                                      <?php 
                                                }
                                      ?>
                                    </optgroup>
                    ...
                    <div class="d-inline-flex mb-3">
                        <div class="text-break" style="margin: 3px;">
                          ...
                          <input value="<?php echo $g['jina']; ?>"  class="form-control form-control-lg border-dark shadow-lg" type="text" id="#" style="width: 500px; color: #fc0339;" name="jina" required readonly>
                        </div>

                        <div class="text-break" style="margin: 3px;">
                          <label class="form-label" for="" style="color: rgb(0,0,0);">HADHI YA MKAZI*: <span style="color: #fc0339;">    Mfano  :- Baba </span></label>
                          <input value="<?php echo $g['hadhi']; ?>" class="form-control form-control-lg border-dark shadow-lg"  type="text" id="#" style="width: 500px; color: #fc0339;" name="hadhi" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="d-inline-flex mb-3">
                        <div style="margin: 3px;">
                          ...
                          <input value="<?php echo $g['date']; ?>" class="form-control form-control-lg border-dark shadow-lg" type="date" style="width: 500px; color: #fc0339;" name="date" required readonly>
                        </div>
                        <div class="text-break" style="margin: 3px;">
                          <label class="form-label" for="" style="color: rgb(0,0,0);">SHUGHULI YA KIJAMII*: <span style="color: #fc0339;">    Mfano  :- Mwalimu </span></label>
                          <input value="<?php echo $g['act']; ?>" class="form-control form-control-lg border-dark shadow-lg" type="text" style="width: 500px; color: #fc0339;" name="act" required readonly>
                        </div>
                    </div>
                    ...
                    <div class="d-inline-flex mb-3">
                        <div style="margin: 3px;">
                          ...
                          <input value="0<?php echo $g['simu']; ?>" required class="form-control form-control-lg border-dark shadow-lg" type="text" id="#" style="width: 500px;margin: 3px; color: #fc0339;" name="simu" required readonly>
                        </div>
                        <div class="text-break" style="margin: 3px;">
                          <label class="form-label" for="" style="color: rgb(0,0,0);">BARUA PEPE*: <span style="color: #fc0339;">    Mfano  :- isrms@email.com </span></label>
                          <input value="<?php echo $g['email']; ?>" required class="form-control form-control-lg border-dark shadow-lg" type="#" id="#" aria-describedby="#" style="width: 500px; color: #fc0339;" name="email" required readonly>
                        </div>
                    </div>
                    <div class="border rounded-pill mb-3" style="width: 371px;">
                        <div class="row" style="width: 500px;">
                           <div class="col text-right">
                              <button class="btn btn-primary btn-lg d-block w-100" type="submit" name="hamisha">HAMISHA MKAZI</button>
                            </div>
                        </div>
                    </div>
                </form>
