...
if(isset($_POST['ongeza'])){
 ...
 $info = $_POST['id'];
    ...
    $sql = "UPDATE data SET  nyumba_no='$nambali', maarufu='$jina' WHERE data_id='$info'";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-center text-white border rounded mb-0" style="color: rgb(0,0,0);background: #4e73df;width: 115.047px;"></h3>
                    </div>
                ...
                ?>
                    ...
                    <h3 class="text-center text-dark mb-4" style="color: var(--bs-dark);font-size: 36px;"><strong>BADILI TAARIFA</strong></h3>
                    <form class="text-center" data-bss-hover-animate="#bounce" style="text-align: left;" method="post">
                        <div class="d-inline-flex mb-3">
                            <div style="margin: 3px;"><label class="form-label" for="" style="color: rgb(0,0,0);margin: 3px;">NAMBARI YA NYUMBA:</label><input value ="<?php echo $data['nyumba_no']; ?>" class="form-control border-dark shadow-lg  form-control-lg" type="text" id="" style="width: 500px;margin: 3px; color: #fc0339;" name="nambali" required></div>
                            <div class="text-break" style="margin: 3px;"><label class="form-label" for="" style="color: rgb(0,0,0);">JINA MAARUFU</label><input value ="<?php echo  mb_strtoupper($data['maarufu']);  ?>" class="form-control  border-dark shadow-lg form-control-lg" type="text" id="" style="width: 500px; color: #fc0339;" name="jina" required></div>
                        </div>
                        ...
                        <div class="text-center border rounded mb-3" style="width: 371px;padding: -3px;">
                            <div class="row" style="width: 500px;">
                                <div class="col text-center"><button class="btn btn-primary btn-lg d-block w-100" type="submit" style="text-align: center;" name="ongeza">BADILI</button></div>
                            </div>
                            <?php
                                 }
                             ?>
